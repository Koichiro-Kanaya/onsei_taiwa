...
def response_gen(siri, question, nega_cnt, posi_cnt, sidnum):
    ...
    answer, _ = siri.talk(member_list[sidnum - 1], question, happy_cnt=posi_cnt, angry_cnt=nega_cnt)
    print('Siri' + siri.get_mode(member_list[sidnum - 1]) + 'モード : ' + answer) # => ('せやな！', None)
    print(siri.score)
    print(posi_cnt)
    print(nega_cnt)
    print('\n')
